        ...
        ZStack{
            ...
            VStack(spacing:15){
                ...
                Button(action: {
                    ...
                    Rectangle()
                        .frame(width: 125, height: 1, alignment: .center).foregroundColor(.white)
                    Circle().strokeBorder(Color("tt"),lineWidth: 2 )
                        .frame(width: 15, height: 15, alignment: .center)
                        .background(Circle().foregroundColor(.white))
...
struct Hellow3_Previews: PreviewProvider {
    static var previews: some View {
        Hellow3(Swift22: .constant(3))
    }
}
